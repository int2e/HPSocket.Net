...
namespace HPSocket
{
    ...
    /// http easy agent
    /// </summary>
    public interface IHttpEasyAgent : IHttpAgent, IHttpEasyData
    {
        #region Easy事件
        ...
        /// </summary>
        event HttpAgentEasyDataEventHandler OnEasyChunkData;
        /// <summary>
        /// 每次到一个完整的http get/post数据包 事件到达同时表示message接收完成
        /// </summary>
        event HttpAgentEasyDataEventHandler OnEasyMessageData;
        /// <summary>
        /// 每次到一个完整的web socket数据包 事件到达同时表示web socket message接收完成
        /// </summary>
        event HttpAgentWebSocketEasyDataEventHandler OnEasyWebSocketMessageData;
