...
{
    public class HttpsEasyServer : HttpEasyServer, IHttpsEasySerer
    {
        #region 保护成员
        ...
        protected HttpsEasyServer(Sdk.CreateListenerDelegate createListenerFunction, Sdk.CreateServiceDelegate createServiceFunction, Sdk.DestroyListenerDelegate destroyServiceFunction, Sdk.DestroyListenerDelegate destroyListenerFunction)
