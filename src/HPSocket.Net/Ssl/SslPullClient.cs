...
{
    public class SslPullClient : SslClient, ISslPullClient
    {
        public SslPullClient()
            : base(Sdk.Tcp.Create_HP_TcpPullClientListener,
                Sdk.Ssl.Create_HP_SSLPullClient,
                Sdk.Ssl.Destroy_HP_SSLPullClient,
                Sdk.Tcp.Destroy_HP_TcpPullClientListener)
        {
        }

        protected SslPullClient(Sdk.CreateListenerDelegate createListenerFunction, Sdk.CreateServiceDelegate createServiceFunction, Sdk.DestroyListenerDelegate destroyServiceFunction, Sdk.DestroyListenerDelegate destroyListenerFunction)
