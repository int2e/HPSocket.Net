...
namespace HPSocket
{
    ...
    /// http easy client
    /// </summary>
    public interface IHttpEasyClient : IHttpClient, IHttpEasyData
    {
        #region Easy事件
        ...
        /// </summary>
        event HttpClientEasyDataEventHandler OnEasyChunkData;
        /// <summary>
        /// 每次到一个完整的http get/post数据包 事件到达同时表示message接收完成
        /// </summary>
        event HttpClientEasyDataEventHandler OnEasyMessageData;
        /// <summary>
        /// 每次到一个完整的web socket数据包 事件到达同时表示web socket message接收完成
        /// </summary>
        event HttpClientWebSocketEasyDataEventHandler OnEasyWebSocketMessageData;
