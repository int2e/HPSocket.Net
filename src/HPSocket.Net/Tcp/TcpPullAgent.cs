...
namespace HPSocket.Tcp
{
    ...
    /// tcp pull agent
    /// </summary>
    public class TcpPullAgent : TcpAgent, ITcpPullAgent
    {
        public TcpPullAgent()
            : base(Sdk.Tcp.Create_HP_TcpPullAgentListener,
                Sdk.Tcp.Create_HP_TcpPullAgent,
                Sdk.Tcp.Destroy_HP_TcpPullAgent,
                Sdk.Tcp.Destroy_HP_TcpPullAgentListener)
        {
        }

        protected TcpPullAgent(Sdk.CreateListenerDelegate createListenerFunction, Sdk.CreateServiceDelegate createServiceFunction, Sdk.DestroyListenerDelegate destroyServiceFunction, Sdk.DestroyListenerDelegate destroyListenerFunction)
